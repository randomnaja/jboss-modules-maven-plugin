...
public final class MojoRepositoryBuilder implements RepositoryBuilder
{
  ...
  // --- object basics --------------------------------------------------------
    ...
    public MojoRepositoryBuilder with(Log log) {
        this.log = log;
        return this;
    }

    public MojoRepositoryBuilder withIgnoreProvidedScope(boolean ignoreProvidedScope) {
        this.ignoreProvidedScope = ignoreProvidedScope;
        return this;
    }

    public MojoRepositoryBuilder withIgnoreTestScope(boolean ignoreTestScope) {
    ...
    @Override
    public boolean getIgnoreProvidedScope() {
        return ignoreProvidedScope;
    }
